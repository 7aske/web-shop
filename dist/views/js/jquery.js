...
!(function(e, t) {
		...
		w.extend({
			...
			isPlainObject: function(e) {
				...
				return (
					...
					(!(t = i(e)) ||
						("function" == typeof (n = f.call(t, "constructor") && t.constructor) && d.call(n) === p))
				);
			},
				...
				if ((n = r.relative[e[s].type])) d = [me(be(d), n)];
					...
					if ((n = r.filter[e[s].type].apply(null, e[s].matches))[x]) {
						...
						return Ce(
							s > 1 && be(d),
							s > 1 &&
								ye(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(
									$,
									"$1"
								),
							n,
			...
			(s = oe.select = function(e, t, n, i) {
				...
				if (((n = n || []), 1 === p.length)) {
					...
					while (o--) {
						...
						if (
							(f = r.find[c]) &&
							(i = f(l.matches[0].replace(Z, ee), (J.test(s[0].type) && ge(t.parentNode)) || t))
						) {
	...
	((w.fn.init = function(e, t, n) {
		...
		if (((n = n || j), "string" == typeof e)) {
			if (
				!(i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : q.exec(e)) ||
				(!i[1] && t)
			)
										...
										: function() {
												try {
													...
													w.Deferred.exceptionHook &&
														...
														t + 1 >= o &&
															(r !== M && ((u = void 0), (s = [e])), n.rejectWith(u, s));
												}
										  };
								t
									? c()
			...
			if (v && (s = v.events)) {
				...
				while (l--)
					if (((u = Te.exec(t[l]) || []), (p = g = u[1]), (h = (u[2] || "").split(".").sort()), p)) {
						...
						a &&
							!d.length &&
							((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) || w.removeEvent(e, p, v.handle),
							delete s[p]);
				...
				while ((o = u[n++]) && !t.isPropagationStopped()) {
					...
					while ((a = o.handlers[r++]) && !t.isImmediatePropagationStopped())
						(t.rnamespace && !t.rnamespace.test(a.namespace)) ||
							...
							(t.data = a.data),
							void 0 !==
								(i = ((w.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, s)) &&
								!1 === (t.result = i) &&
	...
	function Be(e, t, n) {
		for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
			n || 1 !== r.nodeType || w.cleanData(ve(r)),
				r.parentNode &&
					(n && w.contains(r.ownerDocument, r) && ye(ve(r, "script")), r.parentNode.removeChild(r));
		return e;
	}
	w.extend({
	...
	function Ze(e, t, n, r, i, o) {
		...
		return (
			!r &&
				o >= 0 &&
				(s += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - s - u - 0.5))),
			s
		);
	}
	function et(e, t, n) {
				...
				while ((u = y[a++]) && !t.isPropagationStopped())
					(h = u),
						...
						(d = c && u[c]) &&
							d.apply &&
							Y(u) &&
							((t.result = d.apply(u, n)), !1 === t.result && t.preventDefault());
				return (
					(t.type = m),
					o ||
	...
	(w.param = function(e, t) {
		...
		(w.parseHTML = function(e, t, n) {
			...
			return (
				...
				o
					? [t.createElement(o[1])]
					: ((o = be([e], t, a)), a && a.length && w(a).remove(), w.merge([], o.childNodes))
			);
		}),
		(w.offset = {
